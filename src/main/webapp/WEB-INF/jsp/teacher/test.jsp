...
<head>
	...
	<!-- 引入主题样式 -->
	<link type="text/css" href="${pageContext.request.contextPath }/static/themes/default/easyui.css" rel="stylesheet">
	<!-- 引入图标的样式 -->
	<link type="text/css" href="${pageContext.request.contextPath }/static/themes/icon.css" rel="stylesheet">
	<!-- 引入jquery -->
	<script type="text/javascript"	src="${pageContext.request.contextPath }/static/js/jquery-easyui-1.5.3/jquery.min.js"></script>
	<!-- 引入easyui.js -->
